...
// Suas credenciais do Firebase (Atualizadas conforme o seu bloco)
...
// Exportando tudo para o auth.js e o app.js usarem
export { 
    auth, db, provider, signInWithPopup, onAuthStateChanged, 
    createUserWithEmailAndPassword, signInWithEmailAndPassword, 
    signOut, doc, setDoc, getDoc, updateDoc 
};
